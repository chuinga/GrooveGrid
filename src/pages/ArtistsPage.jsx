...
const ArtistsPage = () => {
  ...
  return (
    <div>
      ...
      {user && (
        <button onClick={() => setIsCreateArtistModalOpen(true)}>
          Add New Artist
        </button>
      )}
      ...
      >
        <CreateArtistForm onCreateArtist={handleCreateArtist} genres={genres} />
      </Modal>

      {/* Button to open delete artist modal */}
      {user && (
        <button onClick={() => setIsDeleteArtistModalOpen(true)}>
          Delete Artist
        </button>
      )}
