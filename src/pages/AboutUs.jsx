...
import Josip from "../images/Josip.jpg";
...
function AboutUs() {
  return (
    <div className="aboutUsDiv">
      ...
      <div className="vasco">
        <h3>Vasco Godinho</h3>
        {/*<img src={} alt="Vasco's Picture"></img> */}
        <p>
          Hi! I'mand I'm 28 years old and I was borned and raised in Portugal.
          During my academics in Sound Design, I've always been interested in
          programming, working on some visual and sound projects. My main
          hobbies are listening to music and playing video games.
        </p>
