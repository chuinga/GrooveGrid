...
function AboutUs() {
    return (
        <div className='about'>
                ...
                <div className="about-description">
                    ...
                    <div className="about-links">
                        <Link to='https://github.com/gudwalMJ'>
                            <img className="about-logo" src={gitHubLogo} alt='Github Page' />
                        </Link>
                        <Link to='https://www.linkedin.com/in/josip-milan-4738a9183/'>
                            <img className="about-logo" src={linkedinLogo} alt='Linkedin Logo' />
                        </Link>
                    </div>
                </div>
            </div>
            ...
            <div className="about-member">
                <div className="about-image-container">
                    <img className="about-image" src={Carina} alt="Carina's Image" />
                </div>
                <div className="about-description">
                    <h2 className="about-carina">Carina França</h2>
                    <p>
                         I'm a Brazilian living
            ...
            <div className="about-member">
                ...
                <div className="about-description">
                    ...
                    <p>
                         When I'm not immersed in code, you'll often find me tearing up the trails on my downhill bike, embracing the thrill of speed and adventure.
