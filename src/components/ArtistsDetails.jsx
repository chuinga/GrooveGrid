  ...
  return (
    <div className="main-wrapper">
      <div className="artists-details-wrapper">
        <div>
          <h1 className="artist-details-title">Artist Details</h1>
          <h2 className="artist-details-artist">{artist.name}</h2>
          <img
            src={artist.image}
            alt={`${artist.name} thumbnail`}
            className="artist-details-image"
          />
          <p className="artist-details-genre">Genre: {artist.genre.name}</p>
          <div className="albums-and-buttons-wrapper">
            <h3 className="artist-details-albums">Albums:</h3>
            <ul>
              {artist.albums.map((album) => (
                <li key={album._id} className="artist-details-link">
